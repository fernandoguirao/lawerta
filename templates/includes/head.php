...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  <head>
    ...
    <script src="static/js/vendor/less-1.4.1.min.js" type="text/javascript"></script>
    <!--<script type="text/javascript" charset="utf-8" src="skate-loader_edgePreload.js"></script> -->
